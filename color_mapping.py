...
if __name__=='__main__':
    source_img_path = "C:\\VisualStudioCode\\Project2\\Flo_75_112.jpg"
    filter_img_path = "C:\\VisualStudioCode\\Project2\\juanitocd01_80_120.jpg"
    ...
    print(f"Before: {source_image}")
    source_image = np.array(source_image) 
    print(f"After: {source_image}")
