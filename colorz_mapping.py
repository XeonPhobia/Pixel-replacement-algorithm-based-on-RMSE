...
def replace_pixel2(source_image, filter_image, source_pixel):
    return "variabelz"  
...
if __name__=='__main__':
    ...
    koblingstabell_dictionary[0] = replace_pixel2(source_image, filter_image, 0, koblingstabell_dictionary)  
    koblingstabell_dictionary[1] = replace_pixel2(source_image, filter_image, 1, koblingstabell_dictionary)
